...
var Popover = React.createClass({
    ...
    computeGeometry({contentSize, placement}, fromRect, displayArea) {
        ...
        if (fromRect && fromRect.SCREEN_WIDTH != undefined && fromRect.SCREEN_HEIGHT != undefined) {
            displayArea = new Rect(10, 20, fromRect.SCREEN_WIDTH-20, fromRect.SCREEN_HEIGHT-20);
        } else if (displayArea.x === undefined || displayArea.y === undefined) {
    ...
    getTranslateOrigin() {
        ...
        console.log(JSON.stringify(popoverOrigin));
